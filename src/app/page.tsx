...
export default function Home() {
  return (
    <div className="relative flex min-h-full flex-col items-center px-5 pb-20 pt-16 sm:px-8 sm:pb-24 sm:pt-20">
      <Link
        href="/settings"
        className="absolute right-5 top-5 inline-flex items-center gap-1.5 rounded-[var(--musai-radius)] border border-[var(--musai-border)] bg-[var(--musai-surface)] px-3 py-1.5 text-[12px] font-medium text-[var(--musai-muted)] shadow-[var(--musai-shadow)] transition-colors duration-200 hover:border-[color-mix(in_srgb,var(--musai-accent)_28%,var(--musai-border))] hover:text-[var(--musai-ink)] sm:right-8 sm:top-6"
